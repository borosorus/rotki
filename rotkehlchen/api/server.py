...
from rotkehlchen.api.v1.resources import (
    ...
    CustomPriceFormulaTestResource,
...
URLS_V1: URLS = [
    ...
    ('/assets/custom-price-formulas', CustomPriceFormulasResource),
    ('/assets/custom-price-formulas/test', CustomPriceFormulaTestResource),
